...
void SymbolicObjectWriter::Serialize(ostream &os) const {
	...
	os.write((char*)&start_, sizeof(start_)); send_server_object( "addr_t", strlen("addr_t"));send_server_object((char*)&start_,  sizeof(start_)); 
	os.write((char*)&size_, sizeof(size_)); send_server_object( "size_t", strlen("size_t"));send_server_object((char*)&size_, sizeof(size_));
	os.write((char*)&managerIdx_, sizeof(managerIdx_));send_server_object( "size_t", strlen("size_t"));send_server_object((char*)&managerIdx_, sizeof(managerIdx_)); 
	os.write((char*)&snapshotIdx_, sizeof(snapshotIdx_)); send_server_object( "size_t", strlen("size_t"));send_server_object((char*)&snapshotIdx_, sizeof(snapshotIdx_));
	mem_.Serialize(os);
	size_t size = writes_.size();
	os.write((char*)&size, sizeof(size)); send_server_object( "size_t", strlen("size_t"));send_server_object((char*)&size, sizeof(size));
...
void SymbolicObjectWriter::send_server_object(char* message, int cap) const {

	//printf("send_server_object message: \n");
